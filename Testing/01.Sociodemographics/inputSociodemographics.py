...
filePath     = 'dbfs:/FileStore/usr_shared_cat_analytics/Sociodemographics/MBI_MarketData_2021_EE_Omavalitsuste_20221117.csv'
...
filePath     = 'dbfs:/FileStore/usr_shared_cat_analytics/Sociodemographics/MBI_MarketData_2021_LV_Novadi_20221117.csv'
...
filePath     = 'dbfs:/FileStore/usr_shared_cat_analytics/Sociodemographics/MBI_MarketData_2021_LT_Savivaldybes_20221117.csv'
...
sd = [sd_SE.columns, sd_IE.columns, sd_PL.columns, sd_DK.columns, sd_NO.columns, 
...
all_cols = list(set(sd_SE.columns) | set(sd_IE.columns) | set(sd_PL.columns) | set(sd_NO.columns) | set(sd_DK.columns)
                        | set(sd_EE.columns) | set(sd_LT.columns) | set(sd_LV.columns) 
                       )
falled_out_cols = list((set(sd_SE.columns) | set(sd_IE.columns) | set(sd_PL.columns) | set(sd_NO.columns) | set(sd_DK.columns)
                        | set(sd_EE.columns) | set(sd_LT.columns) | set(sd_LV.columns) 
                       ) - set(sd_common_cols))
...
sd_list = {'SE': sd_SE, 'IE': sd_IE, 'PL': sd_PL, 'DK': sd_DK, 'NO': sd_NO, 'EE': sd_EE, 'LV': sd_LV, 'LT': sd_LT}
